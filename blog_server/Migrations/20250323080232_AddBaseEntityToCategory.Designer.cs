...
namespace blog_server.Migrations
{
    ...
    [Migration("20250323080232_AddBaseEntityToCategory")]
    partial class AddBaseEntityToCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("blog_server.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 3, 23, 8, 2, 32, 395, DateTimeKind.Utc).AddTicks(5750),
                            Description = "Administrator role",
                            Name = "ADMIN",
                            UpdateDate = new DateTime(2025, 3, 23, 8, 2, 32, 395, DateTimeKind.Utc).AddTicks(5750)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("blog_server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "vUhHzRedLk8FR1cVTFf0xiZyyAsUZ1a3RNk8uo6bQZH8kibHOrzUrAj3YvYktt+iIFmP0NeYMNjPe7ubH8zp5n+AN32KX2xbFvF0lNFpp1Q=",
                            Status = 1,
                            UpdateDate = new DateTime(2025, 3, 23, 8, 2, 32, 395, DateTimeKind.Utc).AddTicks(5750),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            PasswordHash = "Osq+ZqyuCq20J1ztPP6kMkGcF3sIoL7OLbdM5eRKhizpYKVfs5TRcMg79rGMfTKK0gntim4ssyPYSMwlzUEw6Npnz6bGuYSw2UVKTxoquXc=",
                            Status = 1,
                            UpdateDate = new DateTime(2025, 3, 23, 8, 2, 32, 395, DateTimeKind.Utc).AddTicks(5750),
                            Username = "user"
                        });
            ...
            modelBuilder.Entity("blog_server.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            JoinDate = new DateTime(2025, 3, 23, 8, 2, 32, 395, DateTimeKind.Utc).AddTicks(5750)
                        },
                        new
                        {
