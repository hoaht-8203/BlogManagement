...
namespace blog_server.Migrations
{
    ...
    [Migration("20250331163053_AddPhoneAndAvatarUrlToUserModel")]
    partial class AddPhoneAndAvatarUrlToUserModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("blog_server.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2025, 3, 31, 16, 30, 53, 630, DateTimeKind.Utc).AddTicks(690),
                            Description = "Administrator role",
                            Name = "ADMIN",
                            UpdateDate = new DateTime(2025, 3, 31, 16, 30, 53, 630, DateTimeKind.Utc).AddTicks(690)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("blog_server.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "B/6pahLqLf67B15e42OIGvYMMY3YAMsDEWep+X3jma5lA9c4ePMy/fgmVkYWdKfdWwLDf/9ILkDUwlkNbvnfuhDcvA+elhqD55P67DPZ66s=",
                            Status = 1,
                            UpdateDate = new DateTime(2025, 3, 31, 16, 30, 53, 630, DateTimeKind.Utc).AddTicks(690),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            IsEmailVerified = false,
                            PasswordHash = "flIlqs1wuPogqZsynER/UEIss0OZvQMZ16gxZcI7/ufSynBBi/AT3NcNr0GMrfezDhbHeuTG6AFP3WZjaITASNe0SF6T2Qo63buIOM827zs=",
                            Status = 1,
                            UpdateDate = new DateTime(2025, 3, 31, 16, 30, 53, 630, DateTimeKind.Utc).AddTicks(690),
                            Username = "user"
                        });
            ...
            modelBuilder.Entity("blog_server.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            JoinDate = new DateTime(2025, 3, 31, 16, 30, 53, 630, DateTimeKind.Utc).AddTicks(690)
                        },
                        new
                        {
